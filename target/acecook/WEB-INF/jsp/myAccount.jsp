  ...
  <div class="left_content">
    ...
    <div class="feat_prod_box_details">
      ...
      <div class="contact_form">
        ...
        <form:form name="register" method="post" modelAttribute="loginForm" action="/acecook/myAccount/login" id="loginForm">
          <div class="form_row">
          ...
          <div class="form_row">
            <form:label path="password" class="contact"><strong><spring:message code="pw"/>:</strong></form:label>
