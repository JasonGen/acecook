  ...
  <div class="left_content">
    ...
    <div class="feat_prod_box_details">
      ...
      <div class="contact_form">
        ...
        <form:form id = "userFormInscription" method = "POST" action = "/acecook/register/createUser" modelAttribute = "userForm">
          <div class="form_row">
            <form:label path = "email" class="contact"> <strong><spring:message code="mail"/>:</strong></form:label>
            <form:input path = "email" type="text" class="contact_input" />
            <form:errors path="email"/>
          </div>
          <div class="form_row">
            <form:label path="motDePasse" class="contact">  <strong><spring:message code="pw"/>:</strong></form:label>
            <form:input path = "motDePasse" type="password" class="contact_input" />
            <form:errors path="motDePasse"/>
          </div>
          <div class="form_row">
            <form:label path="confirmationMotDePasse" class="contact"><strong> <spring:message code="confirmPw"/>:</strong></form:label>
            <form:input path = "confirmationMotDePasse" type="password" class="contact_input" />
            <form:errors path="confirmationMotDePasse"/>
          </div>
          <div class="form_row">
            <form:label path = "nom" class="contact"><strong><spring:message code="lastName"/>:</strong></form:label>
            <form:input path = "nom" type="text" class="contact_input" />
            <form:errors path="nom"/>
          </div>
          <div class="form_row">
            <form:label path = "prenom" class="contact"><strong><spring:message code="firstName"/>:</strong></form:label>
          ...
          <div class="form_row">
            <form:label path="numeroRue" class="contact"><strong><spring:message code="streetNumber"/>:</strong></form:label>
            <form:input path="numeroRue" type="text" class="contact_input" />
            <form:errors path="numeroRue"/>
          </div>
          <div class="form_row">
            <form:label  path="rue" class="contact"><strong><spring:message code="street"/>:</strong></form:label>
            <form:input path="rue" type="text" class="contact_input" />
            <form:errors path="rue"/>
          </div>
          <div class="form_row">
            <form:label path="ville" class="contact"><strong><spring:message code="town"/>:</strong></form:label>
            <form:input path="ville" type="text" class="contact_input" />
            <form:errors path="ville"/>
          </div>
          <div class="form_row">
            <form:label path="codePostal" class="contact"><strong><spring:message code="postalCode"/>:</strong></form:label>
